...
public static class VehicleGenerator
{
    ...
    public static Vehicle GenerateVehicle()
    {
        var vehicles = new List<Vehicle>
        {
            ...
            new Vehicle("Fairey Swordfish", "Swordfish.png", 60000),
            new Vehicle("Churchill Gun Carrier", "GunCarrier.png", 35000),
            new Vehicle("T34", "T34.png", 50000),
            new Vehicle("Toyota Land Cruiser", "LandCruiser.png", 25000),
            new Vehicle("B29 Enola Gay", "B29.png", 160000),
